...
from src.api.serializers import GetReservationsSerializer, PostReservationsSerializer


class ReservationsView(OriginAPIView):
    """
    A view class to get all reservations from the current logged in user.
    """
    ...
    def post(self, request: Request, format=None) -> BackendResponse:
        ...
        reservation_serializer = PostReservationsSerializer(data=reservation)
